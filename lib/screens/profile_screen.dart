              ...
              child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Card(
                        ...
                        color: Colors.white,
                        child: ListTile(
                          leading: Icon(Icons.phone, color: Color(0xFFC5C6d0)),
                          title: Text('$phone',
                              style: TextStyle(
                    ...
                    Card(
                        ...
                        child: ListTile(
                            leading:
                                Icon(Icons.email, color: Color(0xFFC5C6d0)),
                            title: Text('$email',
                                style: TextStyle(
                                  fontFamily: 'SourceSansPro-Regular',
                                  fontSize: 13,
                            ...
                            title: GestureDetector(
                              onTap: () {
                                dynamic conversationObject = {
                                  'appId':
                                      '$kchatbot', // The [APP_ID](https://dashboard.kommunicate.io/settings/install) obtained from kommunicate dashboard.
                                };
